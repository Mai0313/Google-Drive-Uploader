...
def search_folder(target_folder_name: str) -> list:  # This is only for searching folders; it is faster
    files = []
    page_token = None
    while True:
...
def search_files(target_file_name: str) -> list:  # This can search ALL files or folder; it might be slow
    files = []
    page_token = None
    while True:
